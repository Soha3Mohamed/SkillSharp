...
namespace SkillSharp
{
    ...
    public interface ISkill
    {
        ...
        public string Handle(string input);//returns a string or answer from a hardcoded list for now but then i will integrate with databases( as i get better in ef core)
